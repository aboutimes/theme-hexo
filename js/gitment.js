...
function renderHeader(_ref, instance) {
  ...
  likeButton.innerHTML = _icons.heart + (meta.reactions && meta.reactions.heart ? ' ' + meta.reactions.heart + ' ' : '') + '喜欢';
...
function renderComments(_ref2, instance) {
  ...
  comments.forEach(function (comment) {
    ...
    var chn_mon_arr = ["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"];
    console.log(chn_mon_arr[8]);
    var commentItem = document.createElement('li');
    commentItem.className = 'gitment-comment';
    commentItem.innerHTML = '\n      <a class="gitment-comment-avatar" href="' + comment.user.html_url + '" target="_blank">\n        <img class="gitment-comment-avatar-img" src="' + comment.user.avatar_url + '"/>\n      </a>\n      <div class="gitment-comment-main">\n        <div class="gitment-comment-header">\n          <a class="gitment-comment-name" href="' + comment.user.html_url + '" target="_blank">' + comment.user.login + '</a>' + (createDate.toString() !== updateDate.toString() ? '<span class="gitment-comment-header" title="comment was edited at ' + updateDate + '">修改于：' + chn_mon_arr[updateDate.getMonth()] + " " + updateDate.getDate() + "," + " " + updateDate.getFullYear() + '</span>' : '<span class="gitment-comment-header" title="comment on ' + createDate + '">评论于：' + chn_mon_arr[createDate.getMonth()] + " " + createDate.getDate() + "," + " " + createDate.getFullYear()) + '</span>' +  '\n          <div class="gitment-comment-like-btn">' + _icons.heart + ' ' + (comment.reactions.heart || '')  + '\n            </div>'  + '</div>\n        <div class="gitment-comment-body gitment-markdown">' + comment.body_html + '</div>\n          </div>\n          ';
...
var github = exports.github = '<i class="icon-github" style="font-size: 44px;"> </i>'
var heart = exports.heart = '<svg class="gitment-heart-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" fill="red"><path d="M25 39.7l-.6-.5C11.5 28.7 8 25 8 19c0-5 4-9 9-9 4.1 0 6.4 2.3 8 4.1 1.6-1.8 3.9-4.1 8-4.1 5 0 9 4 9 9 0 6-3.5 9.7-16.4 20.2l-.6.5zM17 12c-3.9 0-7 3.1-7 7 0 5.1 3.2 8.5 15 18.1 11.8-9.6 15-13 15-18.1 0-3.9-3.1-7-7-7-3.5 0-5.4 2.1-6.9 3.8L25 17.1l-1.1-1.3C22.4 14.1 20.5 12 17 12z"/></svg>';
