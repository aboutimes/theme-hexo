...
function(e, t) {
  ...
  return function(e) {
    ...
    function w(e, t) {
      if (null !== e && void 0 !== e) if ("object" != typeof e && (e = [e]), r(e)) for (var n = 0, o = e.length; n < o; n++) t.call(null, e[n], n, e);
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      for &&Symbol.
      for ("react.element") || 60103, $ = "undefined" != typeof Symbol ? Symbol.
      for ("__preactCompatWrapper") : "__preactCompatWrapper", U = {
        constructor: 1,
        render: 1,
      ...
      }, W = /^(?:accent|alignment|arabic|baseline|cap|clip|color|fill|flood|font|glyph|horiz|marker|overline|paint|stop|strikethrough|stroke|text|underline|unicode|units|v|vert|word|writing|x)[A-Z]/, V = {}, X = void 0 === e || !e.env || "production" !== e.env.NODE_ENV, Y = G.h("a", null).constructor;
  ...
  default = function(e) {
    ...
    var f = n(98),
      ...
      default)(e, [{
          ...
          value: function(e, t) {
            ...
            return t || (t = function() {}), (0, l.render)(c.
    ...
    for, a = i ? Symbol.
    for ("react.element") : 60103, u = i ? Symbol.
    for ("react.portal") : 60106, s = i ? Symbol.
    for ("react.fragment") : 60107, c = i ? Symbol.
    for ("react.strict_mode") : 60108, l = i ? Symbol.
    for ("react.profiler") : 60114, f = i ? Symbol.
    for ("react.provider") : 60109, p = i ? Symbol.
    for ("react.context") : 60110, d = i ? Symbol.
    for ("react.async_mode") : 60111, h = i ? Symbol.
    for ("react.concurrent_mode") : 60111, m = i ? Symbol.
    for ("react.forward_ref") : 60112, v = i ? Symbol.
    for ("react.suspense") : 60113, y = i ? Symbol.
    for ("react.suspense_list") : 60120, g = i ? Symbol.
    for ("react.memo") : 60115, b = i ? Symbol.
    for ("react.lazy") : 60116, w = i ? Symbol.
    for ("react.fundamental") : 60117, _ = i ? Symbol.
    for ("react.responder") : 60118, x = i ? Symbol.
    ...
    (function(e) {
      ...
      function() {
        ...
        for, y = v ? Symbol.
        for ("react.element") : 60103, g = v ? Symbol.
        for ("react.portal") : 60106, b = v ? Symbol.
        for ("react.fragment") : 60107, w = v ? Symbol.
        for ("react.strict_mode") : 60108, _ = v ? Symbol.
        for ("react.profiler") : 60114, x = v ? Symbol.
        for ("react.provider") : 60109, S = v ? Symbol.
        for ("react.context") : 60110, E = v ? Symbol.
        for ("react.async_mode") : 60111, C = v ? Symbol.
        for ("react.concurrent_mode") : 60111, N = v ? Symbol.
        for ("react.forward_ref") : 60112, O = v ? Symbol.
        for ("react.suspense") : 60113, k = v ? Symbol.
        for ("react.suspense_list") : 60120, M = v ? Symbol.
        for ("react.memo") : 60115, P = v ? Symbol.
        for ("react.lazy") : 60116, T = v ? Symbol.
        for ("react.fundamental") : 60117, A = v ? Symbol.
        for ("react.responder") : 60118, j = v ? Symbol.
        for ("react.scope") : 60119, D = function() {}, I = function(e) {
...
*/
    ...
    var N = n(71),
      ...
      B = function(e) {
          ...
          n.state = {
            ...
            return function() {
              ...
              o.unshift("@" + e.user.login), o = o.map(function(e) {
                ...
                S.
              default.update(n.commentEL), n.commentEL.focus()
              })
            }
        ...
        default)({}, {
          ...
          if (o.code) {
            ...
            history.replaceState(null, null, a), n.options = (0, u.
          default)({}, n.options, {
              url: a,
              id: a
      ...
      default)(t, [{
          ...
          default.resolve(n)) : "number" == typeof t && t > 0 ? this.getIssueById().then(function(t) {
          ...
          value: function(e) {
            e.target.src = "/images/github2.svg"
          }
        }, {
          key: "header",
          value: function() {
          ...
          value: function() {
            var e = this,
              ...
              l = u.admin,
              f = r.concat([]);
            return "last" === a && this.accessToken && f.reverse(), b.
          default.createElement("div", {
          ...
          default.createElement("span", {
              ...
              dangerouslySetInnerHTML: {
                __html: this.i18n.t("counts", {
                  counts: '<span class="gt-link gt-link-counts" href="' + (n && n.html_url) + '" target="_blank">' + a + "</span>",
                  smart_count: a
                })
              }
            }), r && b.
      ...
      b = function(e) {
        ...
        return a(t, e), l(t, [{
          ...
          value: function() {
            ...
            return o && i && u.push(this.createHeightPlaceholder()), p.
...
*/
  ...
  default = function() {
    ...
    }, c.spread = n(187), e.exports = c, e.exports.
  default = c
  }, function(e, t, n) {
    "use strict";
      ...
      default)(t, [{
          ...
          value: function() {
            var e = this,
              ...
              d = n.reactions,
              h = "";
            return d && d.totalCount && (h = d.totalCount, 100 === d.totalCount && d.pageInfo && d.pageInfo.hasNextPage && (h = "100+")), m.
          default.createElement("div", {
              ref: function(t) {
                e.node = t
              },
